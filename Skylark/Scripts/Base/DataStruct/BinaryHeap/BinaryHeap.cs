...
namespace Skylark
{
    ...
    public class BinaryHeap<T> where T : IBinaryHeapElement
    {
        ...
        protected BinaryHeapSortMode m_SortMode;
        ...
        public BinaryHeap(T[] dataArray, BinaryHeapSortMode sortMode)
        {
            ...
            m_Array = new T[minSize];
            m_LastChildIndex = 0;
            Insert(dataArray, BinaryHeapBuildMode.Alone);
        }
        ...
        public void Insert(T[] dataArray, BinaryHeapBuildMode buildMode)
        {
            ...
            if (buildMode == BinaryHeapBuildMode.Alone)
            {
                //方式1:直接添加，每次添加都会上浮
        ...
        public void Insert(T element)
        {
            ...
            if (m_Array.Length <= m_LastChildIndex)
            {
                ResizeArray();
            }
            m_Array[m_LastChildIndex] = element;
            ProcolateUp(m_LastChildIndex);
        }
        #endregion
        ...
        public void RebuildAtIndex(int index)
        {
            ...
            if (parentIndex > 0)
            {
                if (m_SortMode == BinaryHeapSortMode.Min)
                {
