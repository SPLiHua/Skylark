...
void main()
{
    ...
    u_xlat8.y = vs_TEXCOORD4.x;
    u_xlat8.z = vs_TEXCOORD2.x;
    u_xlat8.x = vs_TEXCOORD3.x;
    u_xlat16_7.xyz = u_xlat6.xyz * u_xlat8.xyz;
    u_xlat16_7.xyz = u_xlat6.zxy * u_xlat8.yzx + (-u_xlat16_7.xyz);
    u_xlat6.xyz = u_xlat16_7.xzy * vs_TEXCOORD3.yyy;
    u_xlat8.y = u_xlat6.x;
    u_xlat8.xz = vs_TEXCOORD2.xz;
    u_xlat16_7.x = dot(u_xlat8.xyz, (-u_xlat0.xyz));
    u_xlat8.y = u_xlat6.z;
    u_xlat8.xz = vs_TEXCOORD3.xz;
    u_xlat16_7.y = dot(u_xlat8.xyz, (-u_xlat0.xyz));
    u_xlat6.xz = vs_TEXCOORD4.xz;
    u_xlat16_7.z = dot(u_xlat6.xyz, (-u_xlat0.xyz));
    u_xlat16_6.x = dot(u_xlat16_7.xyz, u_xlat16_7.xyz);
    u_xlat16_6.x = inversesqrt(u_xlat16_6.x);
    u_xlat3.xyz = u_xlat16_6.xxx * u_xlat16_7.xyz;
    u_xlat16_1.x = dot(u_xlat3.xyz, u_xlat16_1.xyz);
