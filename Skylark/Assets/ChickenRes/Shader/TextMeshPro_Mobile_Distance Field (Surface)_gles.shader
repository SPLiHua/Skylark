...
void main()
{
    ...
    gl_Position = u_xlat3;
    vs_TEXCOORD4.y = u_xlat3.z * unity_FogParams.z + unity_FogParams.w;
    u_xlat18 = in_TEXCOORD1.x * 0.000244140625;
    u_xlat3.x = floor(u_xlat18);
    u_xlat3.y = (-u_xlat3.x) * 4096.0 + in_TEXCOORD1.x;
    u_xlat3.xy = u_xlat3.xy * vec2(0.001953125, 0.001953125);
    vs_TEXCOORD0.zw = u_xlat3.xy * _FaceTex_ST.xy + _FaceTex_ST.zw;
    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlatb18 = 0.0>=in_TEXCOORD1.y;
    u_xlat18 = u_xlatb18 ? 1.0 : float(0.0);
    u_xlat19 = (-_WeightNormal) + _WeightBold;
    u_xlat18 = u_xlat18 * u_xlat19 + _WeightNormal;
    u_xlat18 = u_xlat18 * 0.25 + _FaceDilate;
    u_xlat18 = u_xlat18 * _ScaleRatioA;
    vs_TEXCOORD5.x = u_xlat18 * 0.5;
    u_xlat18 = u_xlat2.y * hlslcc_mtx4x4unity_MatrixVP[1].w;
    u_xlat18 = hlslcc_mtx4x4unity_MatrixVP[0].w * u_xlat2.x + u_xlat18;
    u_xlat18 = hlslcc_mtx4x4unity_MatrixVP[2].w * u_xlat2.z + u_xlat18;
    u_xlat18 = hlslcc_mtx4x4unity_MatrixVP[3].w * u_xlat2.w + u_xlat18;
    u_xlat2.xy = _ScreenParams.yy * hlslcc_mtx4x4glstate_matrix_projection[1].xy;
    u_xlat2.xy = hlslcc_mtx4x4glstate_matrix_projection[0].xy * _ScreenParams.xx + u_xlat2.xy;
    u_xlat2.xy = u_xlat2.xy * vec2(_ScaleX, _ScaleY);
    ...
    u_xlat19 = abs(in_TEXCOORD1.y) * _GradientScale;
    u_xlat18 = u_xlat18 * u_xlat19;
    u_xlat19 = u_xlat18 * 1.5;
    u_xlat2.x = (-_PerspectiveFilter) + 1.0;
    u_xlat19 = u_xlat19 * u_xlat2.x;
    u_xlat18 = u_xlat18 * 1.5 + (-u_xlat19);
    u_xlat2.xyz = _WorldSpaceCameraPos.yyy * hlslcc_mtx4x4unity_WorldToObject[1].xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_WorldToObject[0].xyz * _WorldSpaceCameraPos.xxx + u_xlat2.xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_WorldToObject[2].xyz * _WorldSpaceCameraPos.zzz + u_xlat2.xyz;
    u_xlat2.xyz = u_xlat2.xyz + hlslcc_mtx4x4unity_WorldToObject[3].xyz;
    ...
    u_xlat3.xyz = u_xlat0.xyz * u_xlat3.xxx;
    u_xlat3.x = dot(u_xlat2.xyw, u_xlat3.xyz);
    vs_TEXCOORD5.y = abs(u_xlat3.x) * u_xlat18 + u_xlat19;
    vs_TEXCOORD2.w = u_xlat1.x;
    ...
    u_xlat18 = u_xlat2.w * u_xlat3.y;
    u_xlat18 = u_xlat2.y * u_xlat3.z + (-u_xlat18);
    u_xlat1.x = in_TANGENT0.w * unity_WorldTransformParams.w;
    vs_TEXCOORD2.y = u_xlat18 * u_xlat1.x;
    vs_TEXCOORD2.z = u_xlat2.x;
    vs_TEXCOORD2.x = u_xlat3.x;
    vs_TEXCOORD3.x = u_xlat3.y;
    vs_TEXCOORD4.x = u_xlat3.z;
    vs_TEXCOORD3.yw = u_xlat1.xy;
    vs_TEXCOORD4.w = u_xlat1.z;
    vs_TEXCOORD3.z = u_xlat2.y;
    vs_TEXCOORD4.z = u_xlat2.w;
    vs_COLOR0 = in_COLOR0;
...
void main()
{
    ...
    u_xlat21 = inversesqrt(u_xlat21);
    u_xlat3.xyz = vec3(u_xlat21) * u_xlat3.xyz;
    u_xlat21 = u_xlat2.w * u_xlat3.y;
    u_xlat21 = u_xlat2.y * u_xlat3.z + (-u_xlat21);
    u_xlat22 = in_TANGENT0.w * unity_WorldTransformParams.w;
    vs_TEXCOORD2.y = u_xlat21 * u_xlat22;
    vs_TEXCOORD3.y = u_xlat22;
    vs_TEXCOORD2.z = u_xlat2.x;
    vs_TEXCOORD2.x = u_xlat3.x;
    vs_TEXCOORD2.w = u_xlat1.x;
    vs_TEXCOORD3.x = u_xlat3.y;
