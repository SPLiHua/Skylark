...
void main()
{
    ...
    u_xlat16_12.xyz = u_xlat16_3.xyz * _OutlineColor.xyz;
    u_xlat16_3.x = vs_COLOR0.w * _OutlineColor.w;
    u_xlat16_13 = u_xlat16_3.w * u_xlat16_3.x;
    ...
    u_xlat16_7.w = u_xlat16_3.x * u_xlat16_3.w + (-u_xlat16_6.w);
    u_xlat16_3 = vec4(u_xlat16_31) * u_xlat16_7;
    u_xlat16_4.w = u_xlat16_5.w * u_xlat16_4.w + u_xlat16_3.w;
    ...
    u_xlat16_16.x = (-_FaceShininess) + _OutlineShininess;
    u_xlat16 = u_xlat30 * u_xlat16_16.x + _FaceShininess;
...
void main()
{
    ...
    u_xlat16_9.xyz = u_xlat16_2.xyz * _OutlineColor.xyz;
    ...
    u_xlat16_7.w = u_xlat16_2.x * u_xlat16_2.w + (-u_xlat16_6.w);
    u_xlat16_2 = u_xlat16_4.xxxx * u_xlat16_7;
    u_xlat16_3.w = u_xlat16_5.w * u_xlat16_3.w + u_xlat16_2.w;
...
void main()
{
    ...
    u_xlat3 = hlslcc_mtx4x4unity_MatrixVP[3] * u_xlat2.wwww + u_xlat3;
    gl_Position = u_xlat3;
    vs_TEXCOORD9 = u_xlat3.z * unity_FogParams.z + unity_FogParams.w;
    u_xlat15 = in_TEXCOORD1.x * 0.000244140625;
    u_xlat3.x = floor(u_xlat15);
    u_xlat3.y = (-u_xlat3.x) * 4096.0 + in_TEXCOORD1.x;
    u_xlat3.xy = u_xlat3.xy * vec2(0.001953125, 0.001953125);
