...
void main()
{
    ...
    u_xlat16_15 = dot(vs_TEXCOORD1.xyz, u_xlat16_2.xyz);
...
void main()
{
    ...
    u_xlat21 = unity_ShadowFadeCenterAndType.w * u_xlat21 + u_xlat4.x;
    ...
    u_xlat16_18 = u_xlat21 * u_xlat16_18 + u_xlat4.x;
...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat16_0.xyz / vec3(u_xlat16_21);
    u_xlat16_0.xyz = u_xlat16_3.xyz + u_xlat16_4.xyz;
    u_xlat10_3.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_0.xyz = u_xlat16_0.xyz * u_xlat10_3.xyz;
    u_xlat4.xyz = vs_TEXCOORD2.xyz + (-unity_ShadowFadeCenterAndType.xyz);
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "LIGHTPROBE_SH" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "SHADOWS_SCREEN" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRECTIONAL" "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "LIGHTPROBE_SH" "SHADOWS_SCREEN" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "LIGHTPROBE_SH" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "UNITY_HDR_ON" }
"#ifdef VERTEX
#version 100
...
SubProgram "gles hw_tier00 " {
Keywords { "DIRLIGHTMAP_COMBINED" "FOG_LINEAR" "LIGHTMAP_ON" "LIGHTPROBE_SH" "UNITY_HDR_ON" }
"#ifdef VERTEX
#version 100
...
void main()
{
    ...
    u_xlat16_12 = max(u_xlat16_1.w, 9.99999975e-05);
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_2.xyz / vec3(u_xlat16_18);
